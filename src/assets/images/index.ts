...
export { default as UserPlaceholderImage } from './user-placeholder.png'
export { default as LogoColoredIcon } from './instagram-colored.webp'
export { default as GridIcon } from './grid.png'
export { default as ListIcon } from './list.png'
